...
`valo-gateway` is being prepared as a public reference implementation of vendor-neutral mechanical enforcement for governed actions.
...
- private Kernel state/admission logic;
